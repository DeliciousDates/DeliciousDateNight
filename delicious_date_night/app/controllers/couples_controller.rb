...
# binding.pry
	...
	def create
		@couple = Couple.create({a_fname: params["a_fname"], a_lname: params["a_lname"], a_age: params["a_age"], a_gender: params["a_gender"], a_email: params["a_email"], b_fname: params["b_fname"], b_lname: params["b_lname"], b_age: params["b_age"], b_gender: params["b_gender"], b_email: params["b_email"], picture_url: params["picture_url"], description: params["description"], password: params[:password], username: params[:username], avatar: params[:avatar]})
		# binding.pry
<<<<<<< HEAD
		if 
		@couple = Couple.create({a_fname: params["a_fname"], a_lname: params["a_lname"], a_age: params["a_age"], a_gender: params["a_gender"], a_email: params["a_email"], b_fname: params["b_fname"], b_lname: params["b_lname"], b_age: params["b_age"], b_gender: params["b_gender"], b_email: params["b_email"], picture_url: params["picture_url"], description: params["description"], password: params[:password], avatar: params[:avatar]})
		# binding.pry
		redirect_to "/"
=======
		redirect_to "/session/new"
>>>>>>> 255276cc42c5777e6f6099eacc39b4da59186c70
	end
	end
